...
# Coorte sintética (20 pacientes) lida por cohort.py em runtime: um único
# JSON (~680 KB) + os áudios .wav. Necessária para a página /patients.
COPY data/patients.json ./data/patients.json
COPY data/patients_media ./data/patients_media
